	...
	stage('Promoting release v5.1') {
        ...
        stages {
            stage('Generating release') {
                steps {
                    sh 'docker tag registry.sonata-nfv.eu:5000/tng-sla-mgmt:latest registry.sonata-nfv.eu:5000/tng-sla-mgmt:v5.1'
                    sh 'docker tag registry.sonata-nfv.eu:5000/tng-sla-mgmt:latest sonatanfv/tng-sla-mgmt:v5.1'
                    sh 'docker push registry.sonata-nfv.eu:5000/tng-sla-mgmt:v5.1'
                    sh 'docker push sonatanfv/tng-sla-mgmt:v5.1'
                }
            }
        }
    }
