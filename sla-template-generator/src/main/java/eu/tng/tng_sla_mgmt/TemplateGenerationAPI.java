...
public class TemplateGenerationAPI {
	...
	// e.g. http://localhost:8080/tng-sla-mgmt/slas/templategeneration?nsId=10&providerId=20&templateName=lala&expireDate=20/02/2018
	@GET 
	@Produces("text/plain")
	public Response getIt(@Context UriInfo info) 
	{
		...
		return Response
				   .status(200)
				   .entity("NS ID : " + nsId + ", from Service Provider : " + providerId
